...
return [
    ...
    */
    ...
    | spécifier rapidement un message personnalisé spécifique à une règle d'attribut donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger notre placeholder d'attribut
    | avec quelque chose de plus lisible comme "Adresse e-mail" au lieu de "email". Cela nous aide simplement à rendre notre message plus expressif.
    |
    */
