...
return [
    ...
    | données par le gestionnaire de mots de passe pour une tentative de mise à jour de mot de passe
    | ayant échoué, comme pour un jeton invalide ou un nouveau mot de passe invalide.
    |
    */
